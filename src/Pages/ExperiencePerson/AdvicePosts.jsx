            ...
            <Tabs>
                <TabList className="flex gap-8 mt-6 ">
                    {advicePostsData?.categories?.map((category, index) => (
                        <Tab
                            className={`text-[20px] font-semibold cursor-pointer p-2 hover:bg-blue-500 hover:text-white transition duration-300 ease-in-out rounded-lg ${activeCategory === index ? 'bg-[#E5ECFF] border rounded-lg border-[#0E286C] text-[#0E286C]' : ''
                                }`}
