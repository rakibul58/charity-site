...
const ExperiencedAdults = ({ experiencedAdults }) => {
    ...
    return (
        ...
        <h1 className="text-[24px] font-bold border-b-2 border-[#FFC062] py-[4px] w-full">
            {experiencedAdults?.title}
        </h1>
        <Tabs>
            <TabList className="flex gap-8 mt-6 ">
                {experiencedAdults?.categories?.map((category, index) => (
                    <Tab
                ...
                <TabPanel key={index}>
                    ...
                    >
                        {category?.about?.map((item, i) => (
                            <SwiperSlide key={i}>
                                <div className="relative mb-[70px] w-5/6 mx-auto mt-4 border rounded-md shadow-md h-[520px]">
                                    ...
                                    <p className='text-[11px] font-semibold text-[#0E286C]'>{item.instructor[0].members} members</p>
                                    </div>
                                    </div>
                                    <button
                                    className="px-[25px] py-[10px] my-6 text-[20px] font-bold mb-3"
                                    style={{
                                        borderRadius: "8px",
...
export default ExperiencedAdults;
